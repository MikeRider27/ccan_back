...
class ChemotherapyModel(BaseModel):
    ...
    request_state_id = db.Column(db.BigInteger, db.ForeignKey(ParameterModel.id))
    ...
    request_state = db.relationship('ParameterModel', foreign_keys=[request_state_id], uselist=False)
    ...
    treatment_plan_list = db.relationship('ChemotherapyTreatmentPlanModel', cascade="all, delete-orphan")
    medicine_list = db.relationship('MedicineChemotherapyModel', cascade="all, delete-orphan")

    def __init__(self, id, date, patient_id, hospital_id, nro_session, request_state_id, observation, session_state_id,
        ...
        self.request_state_id = request_state_id
    ...
    def json(self, jsondepth=0):
        json = {
            ...
            'request_state_id': self.request_state_id,
        ...
        if jsondepth > 0:
            ...
            if self.request_state:
                json['request_state'] = self.request_state.json(jsondepth - 1)
            ...
            json['medicine_list'] = [
                ...
                } for x in self.medicine_list] if self.medicine_list else []
        return json
